...
//      
 ...
 //   }
    ...
    func getAllLocationsForEvents() -> [BOLocation]{
        
        let locationArray: [BOLocation] = BOLocation.mr_findAll() as! [BOLocation]
        return locationArray
    }
    
    func getLocationsSince(lastId:Int){
